...
from .policies.maskable_lstm_mlp import MaskableRecurrentActorCriticPolicy, MaskableRecurrentActorCriticCnnPolicy, MaskableRecurrentMultiInputActorCriticPolicy
from .buffers.maskable_lstm_buffers import (
...
class MaskableRecurrentPPO(OnPolicyAlgorithm):
    ...
    with support for recurrent policies (LSTM) and with maskable actions.
    ...
    policy_aliases: ClassVar[Dict[str, Type[BasePolicy]]] = {
        ...
        "MaskableCnnLstmPolicy": MaskableRecurrentActorCriticCnnPolicy,
        "MaskableMultiInputLstmPolicy": MaskableRecurrentMultiInputActorCriticPolicy
    }
    ...
    def _setup_model(self) -> None:
        ...
        buffer_cls = MaskableRecurrentDictRolloutBuffer if isinstance(
            self.observation_space, spaces.Dict) else MaskableRecurrentRolloutBuffer
    ...
    def collect_rollouts(
        ...
        while n_steps < n_rollout_steps:
            ...
            # TODO: Remove as no Box action space is allowed
